...
KBUILD_CFLAGS += -Werror -Wno-int-conversion -Wno-misleading-indentation -Wno-format-overflow -Wno-format-truncation -Wno-maybe-uninitialized -Wno-array-bounds -Wno-stringop-truncation -Wno-stringop-overflow -Wno-address -Wno-enum-int-mismatch -Wno-pedantic -std=gnu99
