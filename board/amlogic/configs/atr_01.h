...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"setenv bootargs ${bootargs} androidboot.hardware=amlogic androidboot.vendor=leftymods androidboot.product=AtriStation androidboot.model=ATR androidboot.model_version=01 androidboot.bootloader=${bootloader_version} androidboot.build.expect.baseband=N/A;"\
            "run cmdline_keys;"\
            "\0"\
        "switch_bootmode="\
            "get_rebootmode;"\
...
#define CONFIG_DEVICE_VENDOR	"leftymods"
#define CONFIG_DEVICE_PRODUCT	"ATR"
#define CONFIG_DEVICE_VERSION	"01"
...
#define CONFIG_CMD_NET   1
	...
	#define CONFIG_HOSTNAME atristation
